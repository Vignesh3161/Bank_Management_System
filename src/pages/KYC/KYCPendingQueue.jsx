...
const KYCPendingQueue = () => {
  return (
    <div className="page-container fade-in">
      <div className="glass card">
        <h1 className="text-gradient">K Y C Pending Queue</h1>
        <p className="text-secondary">This is the KYC screen for K Y C Pending Queue.</p>
...
export default KYCPendingQueue;
