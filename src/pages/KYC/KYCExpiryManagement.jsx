...
const KYCExpiryManagement = () => {
  return (
    <div className="page-container fade-in">
      <div className="glass card">
        <h1 className="text-gradient">K Y C Expiry Management</h1>
        <p className="text-secondary">This is the KYC screen for K Y C Expiry Management.</p>
...
export default KYCExpiryManagement;
