...
const FraudAlertsReview = () => {
  return (
    <div className="page-container fade-in">
      <div className="glass card">
        <h1 className="text-gradient">Fraud Alerts Review</h1>
        <p className="text-secondary">This is the Manager screen for Fraud Alerts Review.</p>
...
export default FraudAlertsReview;
