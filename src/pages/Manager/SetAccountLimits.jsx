  ...
  return (
    <div className="page-container fade-in">
      <div className="glass card">
        <h1 className="text-gradient">Set Account Limits</h1>
        <p className="text-secondary">This is the Manager screen for Set Account Limits.</p>
...
export default SetAccountLimits;
